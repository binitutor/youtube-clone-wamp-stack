<nav class="flex-div">
    <div class="nav-left flex-div">
        ...
        <svg class="logo" onclick="reload_home()" xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt9" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true">
            <g>
    ...
    <div class="nav-middle flex-div">
        <div class="search-box flex-div">
            ...
            id="search-word">
            <i class="fa fa-search search-icon" onclick="search_video_title()"></i>
        </div>
        <i class="fa fa-microphone mic-icon"></i>

        <div id="search_result" style="display: none">
            <div id="search_result_content">
                <span id="close_search_result"  onclick="close_search_result()">
                    &times;
                </span>
                <div id="search_result_msg">
                    <!-- Search word appears here ... -->
                </div>
    ...
    <div class="nav-right flex-div">
        <?php
            ...
            if( isset( $_SESSION['login_user_id'] ) ){
                ...
                echo '
                <a href="./studio.php" title="YouTube Studio"><i class="fa fa-inbox"></i></a>
                <a title="Upload video" data-bs-toggle="modal" data-bs-target="#videoUploadModal"
                    onclick="load_channel_metadata()"><i class="fa fa-upload"></i>
                </a>
                <a data-bs-toggle="modal" data-bs-target="#goLiveModal" >
                    <i class="fa fa-rss" title="Go Live"></i>
                </a>
                <a href=""><i class="fa fa-bell"></i></a>
                <div class="dropdown">
                    <img src="' . $profilePic . '" alt="profile" class="user-icon" > 
                    <div class="dropdown-content">
                        ...
                        <p><a href="#"><i class="fa fa-gear"></i> Settings</a></p>
                        <p><a onclick="logout()"><i class="fa fa-sign-out"></i> Logout</a></p>
                    </div>
                </div>
                ';
            } else {
                ...
                echo '
                <a href="./login.php">
                    <i class="fa fa-user-circle-o sign-in-icon"></i>
                    <span>Sign in</span>
                </a>
                ';
            }
